...
#
# Script generated by Vivado on Sat Nov 23 08:54:25 +0800 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ROMForCSR.sh
...
#
# Usage        : ROMForCSR.sh
#                ROMForCSR.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ROMForCSR.sh [-reset_run]
#                ROMForCSR.sh [-reset_log]
#                ROMForCSR.sh [-help]
#
...
# script info
echo -e "ROMForCSR.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ROMForCSR.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L dist_mem_gen_v8_0_14 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ROMForCSR xil_defaultlib.ROMForCSR xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ROMForCSR -key {Behavioral:sim_1:Functional:ROMForCSR} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/vivado2023.2/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ROMForCSR.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ROMForCSR.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ROMForCSR.sh [-help]\n\
Usage: ROMForCSR.sh [-step]\n\
Usage: ROMForCSR.sh [-lib_map_path]\n\
Usage: ROMForCSR.sh [-reset_run]\n\
Usage: ROMForCSR.sh [-reset_log]\n\
Usage: ROMForCSR.sh [-keep_index]\n\
Usage: ROMForCSR.sh [-noclean_files]\n\n\
