...
namespace eval ::optrace {
  variable script "K:/Computer_organization/OExp02-IP2SOC/OExp02-IP2SOC.runs/synth_1/CSSTE.tcl"
...
set_property used_in_implementation false [get_files K:/Computer_organization/OExp02-IP2SOC/OExp02-IP2SOC.srcs/constrs_1/imports/OExp02-IP2SOC/A7.xdc]

read_xdc dont_touch.xdc
set_property used_in_implementation false [get_files dont_touch.xdc]
set_param ips.enableIPCacheLiteLoad 1

read_checkpoint -auto_incremental -incremental K:/Computer_organization/OExp02-IP2SOC/OExp02-IP2SOC.srcs/utils_1/imports/synth_1/CSSTE.dcp
